...
rslider bounds(126, 78, 29, 29), channel("Filt1Amount"),   range(0, 1, 0, 1, 0.01), imgfile("Background", "SVG\knob4back.svg"), trackercolour(0, 0, 0, 0) increment(0.01)
...
rslider bounds(126, 78, 29, 29), channel("Filt2Amount"),  range(0, 1, 0, 1, 0.01), imgfile("Background", "SVG\knob4back.svg"), trackercolour(0, 0, 0, 0)
...
rslider  bounds(195, 74, 29, 29), channel("PitchControl2"), range(-6, 6, 0, 0.5, 0.01) ,imgfile("Background", "SVG\knob4back.svg"), trackercolour(0, 0, 0, 0), increment(0.01)
...
rslider  bounds(195, 74, 29, 29), channel("PitchControl3"), range(-6, 6, 0, 0.5, 0.01), imgfile("Slider", "integralknob2.svg"),imgfile("Background", "SVG\knob4back.svg"), trackercolour(0, 0, 0, 0),
